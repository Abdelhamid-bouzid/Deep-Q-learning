...
if __name__ == '__main__':
    ...
    agent = Agent(gamma=0.99,lamda=0.9, epsilon=1, lr=10**-4, input_dims=input_dims1, n_actions=n_actions1, max_size=50000, check_dir='models', replace=10000, batch_size=32,eps_dec=1e-5,eps_min=0.1)
